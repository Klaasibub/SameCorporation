...
def compute_v2(dfct: pd.DataFrame, method):
...
def validate_v2(res: pd.DataFrame, threshold):
...
def benchmark_v2_core(dfc: pd.DataFrame, method, top_n, thresholds, ax=plt, title="Metrics", **kwargs):
...
def benchmark_v2(dfc, method, top_n, suptitle):
